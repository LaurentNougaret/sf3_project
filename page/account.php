<section id="account">
    ...
    <form role="form" class="info">
            ...
            <div class="col-xs-10 col-xs-offset-1 col-sm-4 col-sm-offset-0">
                <div class="form-group">
                    <input type="password" name="password_confirmation" id="password_confirmation"
                           class="form-control input-lg" placeholder="Confirmez mot de passe"
                           tabindex="5">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 ">
                <div class="form-group">
                    <input type="text" name="adress" id="adress" class="form-control input-lg"
        ...
        <div class="row">
            <div class="col-xs-10 col-xs-offset-1 col-sm-4 col-sm-offset-2 ">
                <div class="form-group">
                    <input type="text" name="postalcode" id="postalcode" class="form-control input-lg"
        ...
        <div class="row">
            <div class="col-xs-10 col-xs-offset-1 col-sm-4 col-sm-offset-2 ">
                <div class="form-group">
                    <input type="tel" name="tel" id="tel" class="form-control input-lg"
