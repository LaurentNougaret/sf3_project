...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-3 col-md-3">
            <a href="mail-compose.html" class="btn btn-danger btn-block btn-compose-email">Filtrer les résultats</a> <!--why link?-->
        ...
        <div class="col-sm-9 col-md-9">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">31 garages trouvés à Lyon</h3>
                ...
                <div class="panel-body">
                    <h3>Garage Creuzet Automobiles</h3>
                    <div class="rate1">
                        <div class="rate">
                    ...
                    <div class="alert alert-success">
                        <div class="eachResult">
                            <div class="description">
                                ...
                                Horaires:
                                Du lundi au jeudi de 8h à 12h et de 14h à 19.<br>
                                le vendredi 8h à 12h et de 14h à 18h.<br>
                                Le samedi de 9h30 à 14h.<br><br>
                                <h4>service + :</h4>
