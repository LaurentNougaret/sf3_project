    ...
    <div class="container">
        ...
        <div class="col-xs-12 col-sm-5 info">
            ...
            <div class="col-xs-6">
                ...
                tel : <a href="tel:0000000000">00 00 00 00 00 00</a>
            </div>
            <div class="col-xs-6">
                Horaires:<br>
        ...
        <div class="col-xs-12 col-sm-7 reviews">
            <div class="col-xs-12 col-sm-6 col-sm-offset-3">
                <div class="block-center">
                    <a href="/?page=index#review"><button type="button" class="btn btn-primary btn-lg btn-block center-block">Déposer un avis</button></a>
                </div>
            </div>
            <div class="col-xs-12">
                <h2>Avis</h2>
