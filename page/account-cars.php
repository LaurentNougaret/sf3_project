            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <label for="immatriculation" class="visuallyhidden"></label>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                <label for="engine-type" class="visuallyhidden"></label>
                                <input type="text" name="engine-type" id="engine-type" class="form-control"
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                <label for="version" class="visuallyhidden"></label>
